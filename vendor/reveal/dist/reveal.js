    ...
    getAutoAnimatePairs(e, t) {
      ...
      return (
        ...
        this.findAutoAnimateMatches(
          ...
          t,
          s,
          (e) => e.nodeName + ":::" + e.textContent.trim(),
        ),
        this.findAutoAnimateMatches(
          i,
          e,
  ...
  function $(n, o) {
      ...
      !1 !== H &&
        ...
        (function () {
          (_.slides.classList.add("no-transition"),
            u
              ? _.wrapper.classList.add("no-hover")
              : _.wrapper.classList.remove("no-hover"));
          (ne.render(),
            ie.render(),
            se.render(),
            ue.render(),
        ...
        setInterval(() => {
          ((!re.isActive() && 0 !== _.wrapper.scrollTop) ||
            0 !== _.wrapper.scrollLeft) &&
        ...
        setTimeout(() => {
          (_.slides.classList.remove("no-transition"),
            ...
            Pe({
              type: "ready",
              data: { indexh: c, indexv: h, currentSlide: v },
            }));
        }, 1));
    }
    function Ee(e) {
    ...
    function Re(t) {
      ...
      (_.wrapper.classList.remove(s.transition),
        ...
        a > 1 &&
          ...
          ((S = new W(_.wrapper, () =>
            Math.min(Math.max((Date.now() - Z) / G, 0), 1),
          )),
          S.on("click", Lt),
          (ee = !1)),
    ...
    function xe(e) {
      ("string" == typeof e.layout && (Y.layout = e.layout),
        ...
        Y.layout
          ? a(_.slides, Y.layout + " " + Y.overview)
          : a(_.slides, Y.overview));
    }
    ...
    function Ie() {
      if (_.wrapper && !oe.isActive()) {
        ...
        if (!A.disableLayout) {
          ...
          s !== X &&
            Pe({ type: "resize", data: { oldScale: s, scale: X, size: i } });
        }
        (!(function () {
          if (
            _.wrapper &&
    ...
    function Be(e, t) {
      let i = A.width,
        s = A.height;
      A.disableLayout &&
        ((i = _.slides.offsetWidth), (s = _.slides.offsetHeight));
      const a = {
        width: i,
        height: s,
    ...
    function Oe() {
      return (
        ...
        (!Fe(v) || !v.parentNode.nextElementSibling)
      );
    }
    function Ve() {
      if (A.pause) {
        ...
        (ht(),
          _.wrapper.classList.add("paused"),
          !1 === e && Pe({ type: "paused" }));
      }
    }
    function Ue() {
      const e = _.wrapper.classList.contains("paused");
      (_.wrapper.classList.remove("paused"),
        ct(),
        e && Pe({ type: "resumed" }));
    }
    function We(e) {
    ...
    function Qe() {
      ...
      if (a && void 0 !== c) {
        ...
        (u && (n = de.isActive() ? 6 : A.mobileViewDistance),
          oe.isActive() && (n = Number.MAX_VALUE));
        for (let r = 0; r < a; r++) {
          let o = s[r],
            l = t(o, "section"),
            d = l.length;
    ...
    function yt({ skipFragments: e = !1 } = {}) {
      ...
      if (e || !1 === le.prev())
        if (Ze().up) mt({ skipFragments: e });
          ...
          if (
            ((i = A.rtl
              ? t(_.wrapper, f + ".future").pop()
              : t(_.wrapper, f + ".past").pop()),
    ...
    function bt({ skipFragments: e = !1 } = {}) {
      if (
        ((O.hasNavigatedHorizontally = !0),
        (O.hasNavigatedVertically = !0),
        re.isActive())
      )
        return re.next();
      if (e || !1 === le.next()) {
    ...
    const Ct = {
      ...
      initialize: function (e) {
        ...
        if (
          ((H = !0),
          (_.wrapper = n),
          (_.slides = n.querySelector(".slides")),
          !_.slides)
        )
      ...
      getProgress: function () {
        ...
        if (v) {
          ...
          if (e.length > 0) {
            let i = 0.9;
            t +=
              (v.querySelectorAll(".fragment.visible").length / e.length) * i;
          }
        }
      ...
      setCurrentScrollPage: function (e, t, i) {
        ...
        ((g = v),
          ...
          a &&
            (g &&
              (te.stopEmbeddedContent(g),
              te.stopEmbeddedContent(g.slideBackgroundElement)),
            te.startEmbeddedContent(v),
